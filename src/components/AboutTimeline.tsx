    ...
    <>
      <li>
        <div className="grid md:grid-cols-7 xl:grid-cols-8 items-start relative rounded-xl p-3 sm:p-5 xl:p-6 overflow-hidden">
          <div className="font-semibold md:col-start-3 md:col-span-6 xl:col-start-3 xl:col-span-7 mb-1 ml-9 md:ml-0">
            {head}
          </div>
          <time className="md:col-start-1 md:col-span-2 row-start-1 md:row-end-3 flex items-center font-medium mb-1 md:mb-0">
            {isCurrent ? (
          ...
          <p className="text-sm md:col-start-3 md:col-span-6 xl:col-span-7 ml-9 md:ml-0">{body}</p>
        </div>
      </li>
    </>
  );
